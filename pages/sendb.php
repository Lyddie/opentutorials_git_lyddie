...
<body>
        <div class="col-lg-12">
            <h1 class="page-header" style="margin-top:20px;">실체험자 문자발송</h1>
        </div>                <!-- /.col-lg-12 -->
	        ...
	        *****************************************************************/
	        ...
	        <form name="form" method="post" action="<?=$_SERVER['PHP_SELF']?>" enctype="multipart/form-data">
		        ...
		        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>lms 제목</label>
                            <input name="subject" type="text" class="form-control" value="[텔라]무료체험 재신청안내" />
                        </div>
                        <div class="form-group">
                            <label>내용</label>
                            <script>
                            ...
                            <textarea name="msg" rows="7" class="form-control">님, 텔라입니다. 어제 무료체험 진행이 어려우셨나봅니다. 원하는 시간에 텔라의 무료 체험을 다시 받아보실 수 있도록 도와드리겠습니다.
