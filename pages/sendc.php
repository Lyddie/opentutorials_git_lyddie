...
<body>
        <div class="col-lg-12">
            <h1 class="page-header" style="margin-top:20px;">진체험자 문자발송</h1>
        </div>                <!-- /.col-lg-12 -->
	        ...
	        *****************************************************************/
	        ...
	        <form name="form" method="post" action="<?=$_SERVER['PHP_SELF']?>" enctype="multipart/form-data">
		        ...
		        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>lms 제목</label>
                            <input name="subject" type="text" class="form-control" value="[텔라] 무료체험 잘 받아보셨나요?" />
                        </div>
                        <div class="form-group">
                            <label>내용</label>
                            <script>
                            ...
                            <textarea name="msg" rows="7" class="form-control">님, 텔라입니다. 어제 무료체험은 잘 받아보셨나요? 지금 홈페이지(http://tella.co.kr )로 가시면, 회원가입 즉시 15%할인쿠폰이 지급됩니다! 
수업 관련하여 궁금하신 사항이 있으시면, 아래 링크를 통해 텔라 고객센터로 문의해주세요!  

■ 텔라와 실시간 상담하기
https://goo.gl/iNxzIG </textarea>
                        </div>
                        <div class="form-group">
					    ...
					    //]]>
                            ...
                            <input name="reservetime" class="form-control" id="reservetime" type="text" value="2016-05-24 13:30:00" disabled="disabled" />
                        </div>
